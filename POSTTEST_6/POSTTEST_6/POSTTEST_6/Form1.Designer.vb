...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        btnServis.Anchor = AnchorStyles.Bottom Or AnchorStyles.Right
        btnServis.BackColor = Color.SteelBlue
        btnServis.ForeColor = Color.White
        btnServis.Font = New Font("Segoe UI", 9, FontStyle.Bold)
        btnServis.Location = New Point(487, 385)
        btnServis.Name = "btnServis"
        btnServis.Size = New Size(90, 35)
        btnServis.TabIndex = 13
        btnServis.Text = "Data Servis"
        ...
        txtCari.PlaceholderText = "Ketik untuk mencari..."
        ...
        dgvSparepart.MultiSelect = False
        dgvSparepart.Size = New Size(465, 240)
    ...
    Friend WithEvents btnServis As Button
