Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = "Data Sparepart - Bengkel"
        RefreshGrid()
    End Sub
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        ...
        Dim dialog As DialogResult = MessageBox.Show("Apakah Anda yakin ingin menghapus data ini?" & vbNewLine &
                                                      "Perhatian: tidak bisa dihapus jika masih dipakai di data servis.",
    ...
    Private Sub btnServis_Click(sender As Object, e As EventArgs) Handles btnServis.Click
        Dim f2 As New Form2()
        f2.ShowDialog()
        RefreshGrid()
    End Sub
